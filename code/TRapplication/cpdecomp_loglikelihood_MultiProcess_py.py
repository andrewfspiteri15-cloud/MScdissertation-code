...
# HAS LASSO REGULARIZATION
def cpdecomp_loglikelihood_MultiProcess_logl(data, labels_onehotencoded, cpdecomp_rank, bias_vector, factor_matrix1_class1, factor_matrix2_class1, factor_matrix3_class1, factor_matrix1_class2, factor_matrix2_class2, factor_matrix3_class2, factor_matrix1_class3, factor_matrix2_class3, factor_matrix3_class3
    ...
    log_likelihood = labels_onehotencoded[0]*(bias_vector[0] + inner_product_class1 - ln_of_innerproduct_exponentials) + labels_onehotencoded[1]*(bias_vector[1] + inner_product_class2 - ln_of_innerproduct_exponentials) + labels_onehotencoded[2]*(bias_vector[2] + inner_product_class3 - ln_of_innerproduct_exponentials) + labels_onehotencoded[3]*(bias_vector[3] + inner_product_class4 - ln_of_innerproduct_exponentials) + labels_onehotencoded[4]*(bias_vector[4] + inner_product_class5 - ln_of_innerproduct_exponentials) + labels_onehotencoded[5]*(bias_vector[5] + inner_product_class6 - ln_of_innerproduct_exponentials) + labels_onehotencoded[6]*(0 - ln_of_innerproduct_exponentials) - (lasso_regparameter * sum_abs_factor_matrix_concatenated)
    
    return log_likelihood

# Using outer_product_factor_matrices_classes prior to it and feeding it the outputs but this is slower than just keeping them combined
# SLOWER THAN THE ORIGINAL [[UNUSED]]
def cpdecomp_loglikelihood_MultiProcess_logl_unused(data, labels_onehotencoded, cpdecomp_rank, bias_vector, outer_product_factor_matrices_class1_list, outer_product_factor_matrices_class2_list, outer_product_factor_matrices_class3_list, outer_product_factor_matrices_class4_list, outer_product_factor_matrices_class5_list, outer_product_factor_matrices_class6_list):
    ...
    # log-likelihood per sample
    log_likelihood = labels_onehotencoded[0]*(bias_vector[0] + inner_product_class1 - ln_of_innerproduct_exponentials) + labels_onehotencoded[1]*(bias_vector[1] + inner_product_class2 - ln_of_innerproduct_exponentials) + labels_onehotencoded[2]*(bias_vector[2] + inner_product_class3 - ln_of_innerproduct_exponentials) + labels_onehotencoded[3]*(bias_vector[3] + inner_product_class4 - ln_of_innerproduct_exponentials) + labels_onehotencoded[4]*(bias_vector[4] + inner_product_class5 - ln_of_innerproduct_exponentials) + labels_onehotencoded[5]*(bias_vector[5] + inner_product_class6 - ln_of_innerproduct_exponentials) + labels_onehotencoded[6]*(0 - ln_of_innerproduct_exponentials)
        
    return log_likelihood

# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# THE BELOW TWO DEFINITIONS ARE NOT USED. PERFORMANCE IS WORSE THAN A SIMPLE FOR LOOP SINCE COMPUTATION IS TOO SIMPLE FOR MULTIPROCESSING
def cpdecomp_loglikelihood_MultiProcess_batches(data, labels_onehotencoded, cpdecomp_rank, bias_vector, factor_matrix1_class1, factor_matrix2_class1, factor_matrix3_class1, factor_matrix1_class2, factor_matrix2_class2, factor_matrix3_class2, factor_matrix1_class3, factor_matrix2_class3, factor_matrix3_class3
                           , factor_matrix1_class4, factor_matrix2_class4, factor_matrix3_class4, factor_matrix1_class5, factor_matrix2_class5, factor_matrix3_class5, factor_matrix1_class6, factor_matrix2_class6, factor_matrix3_class6):
    ...
    return [log_likelihood, inner_product_class1, inner_product_class2, inner_product_class3, inner_product_class4, inner_product_class5, inner_product_class6, ln_of_innerproduct_exponentials]

def cpdecomp_loglikelihood_MultiProcess_batches_cprankmanual(data, labels_onehotencoded, bias_vector, factor_matrix1_class1, factor_matrix2_class1, factor_matrix3_class1, factor_matrix1_class2, factor_matrix2_class2, factor_matrix3_class2, factor_matrix1_class3, factor_matrix2_class3, factor_matrix3_class3
                           , factor_matrix1_class4, factor_matrix2_class4, factor_matrix3_class4, factor_matrix1_class5, factor_matrix2_class5, factor_matrix3_class5, factor_matrix1_class6, factor_matrix2_class6, factor_matrix3_class6):
    
    outer_product_factor_matrices_class1_rank1 = outer2(factor_matrix1_class1[:,0], factor_matrix2_class1[:,0], factor_matrix3_class1[:,0])
    outer_product_factor_matrices_class2_rank1 = outer2(factor_matrix1_class2[:,0], factor_matrix2_class2[:,0], factor_matrix3_class2[:,0])
    outer_product_factor_matrices_class3_rank1 = outer2(factor_matrix1_class3[:,0], factor_matrix2_class3[:,0], factor_matrix3_class3[:,0])
    outer_product_factor_matrices_class4_rank1 = outer2(factor_matrix1_class4[:,0], factor_matrix2_class4[:,0], factor_matrix3_class4[:,0])
    outer_product_factor_matrices_class5_rank1 = outer2(factor_matrix1_class5[:,0], factor_matrix2_class5[:,0], factor_matrix3_class5[:,0])
    outer_product_factor_matrices_class6_rank1 = outer2(factor_matrix1_class6[:,0], factor_matrix2_class6[:,0], factor_matrix3_class6[:,0])
    
    outer_product_factor_matrices_class1_rank2 = outer2(factor_matrix1_class1[:,1], factor_matrix2_class1[:,1], factor_matrix3_class1[:,1])
    outer_product_factor_matrices_class2_rank2 = outer2(factor_matrix1_class2[:,1], factor_matrix2_class2[:,1], factor_matrix3_class2[:,1])
    outer_product_factor_matrices_class3_rank2 = outer2(factor_matrix1_class3[:,1], factor_matrix2_class3[:,1], factor_matrix3_class3[:,1])
    outer_product_factor_matrices_class4_rank2 = outer2(factor_matrix1_class4[:,1], factor_matrix2_class4[:,1], factor_matrix3_class4[:,1])
    outer_product_factor_matrices_class5_rank2 = outer2(factor_matrix1_class5[:,1], factor_matrix2_class5[:,1], factor_matrix3_class5[:,1])
    outer_product_factor_matrices_class6_rank2 = outer2(factor_matrix1_class6[:,1], factor_matrix2_class6[:,1], factor_matrix3_class6[:,1])
    
    outer_product_factor_matrices_class1_rank3 = outer2(factor_matrix1_class1[:,2], factor_matrix2_class1[:,2], factor_matrix3_class1[:,2])
    outer_product_factor_matrices_class2_rank3 = outer2(factor_matrix1_class2[:,2], factor_matrix2_class2[:,2], factor_matrix3_class2[:,2])
    outer_product_factor_matrices_class3_rank3 = outer2(factor_matrix1_class3[:,2], factor_matrix2_class3[:,2], factor_matrix3_class3[:,2])
    outer_product_factor_matrices_class4_rank3 = outer2(factor_matrix1_class4[:,2], factor_matrix2_class4[:,2], factor_matrix3_class4[:,2])
    outer_product_factor_matrices_class5_rank3 = outer2(factor_matrix1_class5[:,2], factor_matrix2_class5[:,2], factor_matrix3_class5[:,2])
    outer_product_factor_matrices_class6_rank3 = outer2(factor_matrix1_class6[:,2], factor_matrix2_class6[:,2], factor_matrix3_class6[:,2])
    
    inner_product_class1 = np.inner(vectorize_tensor_3D(outer_product_factor_matrices_class1_rank1 + outer_product_factor_matrices_class1_rank2 + outer_product_factor_matrices_class1_rank3), vectorize_tensor_3D(data))
    inner_product_class2 = np.inner(vectorize_tensor_3D(outer_product_factor_matrices_class2_rank1 + outer_product_factor_matrices_class2_rank2 + outer_product_factor_matrices_class2_rank3), vectorize_tensor_3D(data))
    inner_product_class3 = np.inner(vectorize_tensor_3D(outer_product_factor_matrices_class3_rank1 + outer_product_factor_matrices_class3_rank2 + outer_product_factor_matrices_class3_rank3), vectorize_tensor_3D(data))
    inner_product_class4 = np.inner(vectorize_tensor_3D(outer_product_factor_matrices_class4_rank1 + outer_product_factor_matrices_class4_rank2 + outer_product_factor_matrices_class4_rank3), vectorize_tensor_3D(data))
    inner_product_class5 = np.inner(vectorize_tensor_3D(outer_product_factor_matrices_class5_rank1 + outer_product_factor_matrices_class5_rank2 + outer_product_factor_matrices_class5_rank3), vectorize_tensor_3D(data))
    inner_product_class6 = np.inner(vectorize_tensor_3D(outer_product_factor_matrices_class6_rank1 + outer_product_factor_matrices_class6_rank2 + outer_product_factor_matrices_class6_rank3), vectorize_tensor_3D(data))
